...
/**
    NewTaskDelegate links the NewTaskViewController and the NewTaskModalView. This helps the NewTaskViewContoller know when to dismiss when the x button is tapped on the
